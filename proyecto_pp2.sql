...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-07-2022 a las 19:43:31
...
(1, 1, 'Pubico en general', 925491523, 'Lima', 1);
...
(1, 1, '2022-07-11 14:41:00', 100, '1560.00', 1);
...
(6, '2022-07-11 14:37:57', 1, 1, '4060.00', 1);
...
(1, 'Laptop lenovo', 1, '1560.00', 99, 2),
(2, 'Televisor', 1, '2500.00', 57, 1),
...
(2, 'Maria Perez Miranda', 'maria@gmail.com', 'maria', '263bce650e68ab4e23f28263760b9fa5', 2);
...
ALTER TABLE `cliente`
  ...
  ADD UNIQUE KEY `u_dni` (`dni`) USING BTREE,
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `fk_usuario_id` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`idusuario`);
...
ALTER TABLE `entradas`
  ...
  ADD CONSTRAINT `entradas_ibfk_2` FOREIGN KEY (`codproducto`) REFERENCES `producto` (`codproducto`);
